...
namespace NFSbndlModelChallenger {
    class ParameterEditor {
        ...
        private readonly string veh_path;
        ...
        public float[] Wheel_position {
            get {
                if (wheel_path == null) wheel_path = BNDLHelper.Get_para_path("wheel", veh_path);
            ...
            set {
                if (wheel_path.Count == 0) wheel_path = BNDLHelper.Get_para_path("wheel", veh_path);
        ...
        public float[] Driver_position {
            get {
                if (driver_path == null) driver_path = BNDLHelper.Get_para_path("driver", veh_path);
        ...
        public float[] Hitbox_size {
            get {
                if (hixbox_path == null) hixbox_path = BNDLHelper.Get_para_path("hitbox", veh_path);
